...
<table class="no-border">
    ...
    <tbody>
      <tr>
        <td><img src="{{ '/assets/images/word/Tables formatting/Table Design Borders drop down menu.png' | url }}"  alt="Table Design Borders drop down menu" style="height:100%; width:100%; vertical-align:middle"></td>
        <td><img src="{{ '/assets/images/word/Tables formatting/Table border line edit.gif' | url }}"  alt="Table border line edit" style="height:100%; width:100%; vertical-align:middle"></td>
      </tr>
</table>
...
<img src="{{ '/assets/images/word/Tables formatting/Table shading edit.gif' | url }}"  alt="Table border line edit" style="height:75%; width:75%; vertical-align:middle">
