...
<p><img class="thumbnail" src="{{ '/assets/images/word/Getting started with Word/Hover snap options.png' | url }}"  alt="Hover snap options" style="height:100%; width:100%; vertical-align:middle"></p>
...
<img class="thumbnail border" src="{{ '/assets/images/word/Getting started with Word/Doc icon 2.png' | url }}"  alt="Word doc icon" style="height:100%; width:20%; vertical-align:middle">
